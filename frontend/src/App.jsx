...
function App() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-200">
        <div className="text-center">
          ...
          <p className="text-slate-400 font-mono text-sm">Loading TrustExam...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
      <Suspense fallback={<div className="flex items-center justify-center min-h-screen bg-slate-950 text-slate-400 font-mono text-sm">Loading...</div>}>
        <ErrorBoundary>
          <div className="App">
            <Routes>
              <Route
